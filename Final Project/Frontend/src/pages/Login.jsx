...
const Login = () => {
  ...
  const [userRole, setUserRole] = useState("principal"); // Default role changed to principal
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(`Error While Logging http://localhost:1008/${userRole}/login`);
      console.log(err);
    }
  };
            ...
            isOtpSent ? (
              ...
              <form onSubmit={handleForgotPassword}>
                ...
                <div className="mb-3">
                  ...
                  >
                    <option value="principal">Principal</option> {/* Updated role */}
                    <option value="teacher">Teacher</option> {/* Updated role */}
                    <option value="student">Student</option> {/* Updated role */}
                  </select>
                </div>
                <div className="d-grid">
                  <button type="submit" className="btn btn-primary">
